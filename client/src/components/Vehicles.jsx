...
export const Vehicles = () => {
 const vehicles = [
  ...
  return (
    <section className="min-h-screen py-12 bg-[#f4f8fb]">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-10">All Vehicles</h2>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {vehicles.map((item, index) => (
            <VehiclesCard key={index} vehicles={item} />
          ))}
        </div>
      </div>
    </section>
